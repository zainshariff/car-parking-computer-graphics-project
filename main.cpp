...
glClearColor(.7,0.85,1.0,1.0);// background color
glColor3f(0.25f, 0.25f, 0.25f); // Draw ground color
glBegin(GL_QUADS);
...
glColor3ub(a[i],a[j],c[i]);// standing car color
...
glColor3f(0.8,0.8,0);//main car color
glCallList(carr_display_list);
glPopMatrix();
glutSwapBuffers();
}
